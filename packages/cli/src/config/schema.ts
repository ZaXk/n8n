...
export const schema = {
	...
	executions: {
		...
		concurrency: {
			doc: 'Max number of executions to run in parallel in a single container/process',
			format: Number,
			default: 10,
		...
		manualConcurrency: {
			doc: 'Max number of manual executions to run in parallel in a single container/process',
			format: Number,
			default: 3,
			env: 'EXECUTIONS_MANUAL_CONCURRENCY',
		},
